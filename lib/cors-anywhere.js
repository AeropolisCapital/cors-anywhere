...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ["https://app.aeropolis.capital.com","https://app.aeropolis.capital.com:8080"],            // If non-empty, requests not from an origin in this list will be blocked.
